    ...
    <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="prose prose-blue max-w-none">
        <p className="text-lg mb-8">
          This website is operated by Beyondx Informatics Analytics Private Limited. Throughout the site, 
          the terms &quot;we&quot;, &quot;us&quot; and &quot;our&quot; refer to Beyondx Informatics Analytics Private Limited. Beyondx 
          Informatics Analytics Private Limited offers this website, including all information, tools and 
...
const sections = [
  ...
  },
  {
    ...
    content: [
      ...
      "In no case shall Beyondx Informatics Analytics Private Limited, our directors, officers, employees, affiliates, agents, contractors, interns, suppliers, service providers or licensors be liable for any injury, loss, claim, or any direct, indirect, incidental, punitive, special, or consequential damages of any kind, including, without limitation lost profits, lost revenue, lost savings, loss of data, replacement costs, or any similar damages, whether based in contract, tort (including negligence), strict liability or otherwise, arising from your use of any of the service or any products procured using the service, or for any other claim related in any way to your use of the service or any product, including, but not limited to, any errors or omissions in any content, or any loss or damage of any kind incurred as a result of the use of the service or any content (or product) posted, transmitted, or otherwise made available via the service, even if advised of their possibility. Because some states or jurisdictions do not allow the exclusion or the limitation of liability for consequential or incidental damages, in such states or jurisdictions, our liability shall be limited to the maximum extent permitted by law."
    ]
  },
  {
    title: "SECTION 14 - INDEMNIFICATION",
    content: [
      "You agree to indemnify, defend and hold harmless Beyondx Informatics Analytics Private Limited and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys' fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party."
    ]
  },
  {
  ...
  },
  {
    ...
    content: [
      "Questions about the Terms of Service should be sent to us at team@switch-phone.in",
    ],
  },
]; 